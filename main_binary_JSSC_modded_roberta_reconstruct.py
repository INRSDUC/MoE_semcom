...
from models_2.transceiver_modulation_JSCC_type_2_oke import   MODJSCC_MoE_Faithful, MODJSCC_MoE_Recon 
...
if __name__ == '__main__':
    ...
    deepsc = MODJSCC_MoE_Recon(args.d_model, freeze_bert=False).to(args.device)
