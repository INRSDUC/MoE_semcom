...
parser.add_argument('--checkpoint-path', default='/home/necphy/ducjunior/BERT_Backdoor/checkpoints/JSSC_freeze_roberta', type=str)
...
if __name__ == '__main__':
    ...
    deepsc = MODJSCC_WithHyperprior_real_bit(args.d_model, freeze_bert=True).to(args.device)
