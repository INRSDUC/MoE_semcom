...
import numpy as np
from utils import SNR_to_noise, initialize_weights, train_step,train_step_with_smart, val_step
...
parser.add_argument('--checkpoint-path', default='/home/necphy/ducjunior/BERTDeepSC/checkpoints/deepsc_AWGN_simple', type=str)
